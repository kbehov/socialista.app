...
type StudioTemplatePreviewDialogProps = {
...
export function StudioTemplatePreviewDialog({
  template,
  open,
  onOpenChange,
  onRecreate,
}: StudioTemplatePreviewDialogProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        {template?.description ? (
          <p className="px-4 pb-1 text-[12px] leading-relaxed tracking-[-0.01em] text-black/48 dark:text-white/48">
            {template.description}
          </p>
        ) : null}
