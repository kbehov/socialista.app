...
export function StudioTemplateCard({ template, onPreview, onRecreate }: StudioTemplateCardProps) {
      ...
      <div className="relative">
        ...
        >
          <StudioTemplatePreviewMedia
            ...
            className="size-full transition-transform duration-300 ease-out group-hover/card:scale-[1.03] motion-reduce:transition-none motion-reduce:group-hover/card:scale-100"
          />
          <span
            aria-hidden
