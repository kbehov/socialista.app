  ...
  return (
    <AutocompletePrimitive.Portal {...portalProps}>
      ...
      >
        <span
          className={cn(
            "relative flex max-h-full min-w-(--anchor-width) max-w-(--available-width) origin-(--transform-origin) rounded-lg border border-border bg-card shadow-md transition-[scale,opacity]",
            className,
          )}
        >
