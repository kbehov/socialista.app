...
export function MockupVideo() {
  return (
    <ProductMockup active="video" navItems={STUDIO_MOCKUP_NAV} title="Video editor" inspector={<Inspector />}>
      <div className="flex gap-3">
        <div
          className={`${styles.mockupSwatchAlt} aspect-[9/16] w-[38%] shrink-0 rounded-md border border-border`}
        />
