...
export const dashboardSurface = {
  ...
  segmentItem: 'rounded-md text-[11px] font-medium transition-colors',
  segmentItemActive: 'bg-background text-foreground shadow-xs',
  segmentItemInactive: 'text-muted-foreground hover:text-foreground',

  dividerGrid: 'grid gap-px overflow-hidden rounded-lg border border-border/60 bg-border/50',
  dividerCell: 'bg-background',

  inset: 'rounded-lg border border-border/60 bg-background',
  insetMuted: 'rounded-lg bg-muted/40',
  insetDashed: 'rounded-lg border border-dashed border-border/60 bg-muted/20',
