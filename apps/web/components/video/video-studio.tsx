...
export function VideoStudio() {
  return (
    <div className="video-studio flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden">
      ...
      <div className="flex h-full min-h-0 min-w-0 flex-1 flex-col overflow-hidden lg:flex-row">
        ...
        <aside className="studio-source-panel flex max-h-[min(240px,26vh)] min-h-0 w-full shrink-0 flex-col overflow-hidden border-b lg:hidden">
          <VideoSourcePanel />
        </aside>
