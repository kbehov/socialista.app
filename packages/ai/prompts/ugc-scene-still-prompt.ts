...
You are writing a seed for a photoreal UGC still that will be the start frame of a short-form video.

The attached photos ARE this creator and this product. Do not invent a different person or SKU.
Casual smartphone UGC: lived-in room, natural light, scroll-stopping authenticity.
`.trim()
